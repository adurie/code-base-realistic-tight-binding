...
CMPI      include 'mpif.h'
c
      parameter (nplx=75,nslx=1,nspinx=9,nsubx=4,nsubatx=2)
...
CMPI      include 'mpif.h'
CMPIc
CMPI      parameter (nplx=75,nslx=1,nspinx=9,nsubx=4,nsubatx=2)
...
C       implicit double precision (a-h,o-y)
C       implicit complex*16 (z)
C       parameter (nplx=75,nslx=1,nspinx=9,nsubx=4,nsubatx=2)
