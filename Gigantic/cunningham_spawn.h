...
void aux_square(int depth, double error, int n, double v, double w, VectorXcd &fu, VectorXcd &fd,
	       ...
	       const Matrix3d &baib, double fact, int irecip, dcomp zener, Args&&... params)
{
	...
	aux_square(depth-1, error, n*9, v, w, f1u, f1d, f1ud, f1du, g1u, g1d, g1ud, g1du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v, w + 2*A, f2u, f2d, f2ud, f2du, g2u, g2d, g2ud, g2du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v, w - 2*A, f3u, f3d, f3ud, f3du, g3u, g3d, g3ud, g3du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v + 2*A, w, f4u, f4d, f4ud, f4du, g4u, g4d, g4ud, g4du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v + 2*A, w + 2*A, f5u, f5d, f5ud, f5du, g5u, g5d, g5ud, g5du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v + 2*A, w - 2*A, f6u, f6d, f6ud, f6du, g6u, g6d, g6ud, g6du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v - 2*A, w, f7u, f7d, f7ud, f7du, g7u, g7d, g7ud, g7du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v - 2*A, w + 2*A, f8u, f8d, f8ud, f8du, g8u, g8d, g8ud, g8du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v - 2*A, w - 2*A, f9u, f9d, f9ud, f9du, g9u, g9d, g9ud, g9du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
...
void aux_tri(int depth, double error, int n, double v, double w, VectorXcd &fu, VectorXcd &fd,
	       VectorXcd &fud, VectorXcd &fdu, VectorXcd &zresu, VectorXcd &zresd, VectorXcd &zresud,
	       VectorXcd &zresdu, double A, Vector3d &d1, Vector3d &d2, int nsub, int nsubat,
	       int ndiff, Vector3d &b1, Vector3d &b2, const vector<pair<int,int>> &ifold, int nfold, 
	       const Matrix3d &baib, double fact, int irecip, dcomp zener, Args&&... params)
{
	...
	aux_tri(depth-1, error, n*9, v, w, f1u, f1d, f1ud, f1du, g1u, g1d, g1ud, g1du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v + 2*A, w, f2u, f2d, f2ud, f2du, g2u, g2d, g2ud, g2du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_tri(depth-1, error, n*9, v + 2*A, w + 2*A, f3u, f3d, f3ud, f3du, g3u, g3d, g3ud, g3du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v, w - 2*A, f4u, f4d, f4ud, f4du, g4u, g4d, g4ud, g4du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth-1, error, n*9, v + 2*A, w - 2*A, f5u, f5d, f5ud, f5du, g5u, g5d, g5ud, g5du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_tri(depth-1, error, n*9, v - 2*A, w - 2*A, f6u, f6d, f6ud, f6du, g6u, g6d, g6ud, g6du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
...
//       calculate the function
	...
	aux_tri(depth, error, 9, A, A, f1u, f1d, f1ud, f1du, g1u, g1d, g1ud, g1du, A/3., 
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth, error, 9, 3*A, A, f2u, f2d, f2ud, f2du, g2u, g2d, g2ud, g2du, A/3.,
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth, error, 9, 5*A, A, f3u, f3d, f3ud, f3du, g3u, g3d, g3ud, g3du, A/3.,
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_square(depth, error, 9, 5*A, 3*A, f4u, f4d, f4ud, f4du, g4u, g4d, g4ud, g4du, A/3.,
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_tri(depth, error, 9, 3*A, 3*A, f5u, f5d, f5ud, f5du, g5u, g5d, g5ud, g5du, A/3.,
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
	aux_tri(depth, error, 9, 5*A, 5*A, f6u, f6d, f6ud, f6du, g6u, g6d, g6ud, g6du, A/3.,
		d1, d2, nsub, nsubat, ndiff, b1, b2, ifold, nfold, baib, fact, irecip, zener, params...);
