...
% \begin{axis}
% [
% 			title=Iron spin Down,
% 			ylabel=Energy $(Ry)$,
% 			% ymin=-0.2,
% 			% ymax = 1.,
% 			xtick={0,50,100,150,200,225,250,300,350},
% 			xticklabels={$\Gamma$,$\Delta$,$H$,$F$,$P$,$D$, $N$,$\Sigma$, $\Gamma$},
% 			% xmax = 100,
% 		]
% \addplot [thick, black, discard if not={P}{A}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{B}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{C}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{D}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{E}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{F}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{G}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{H}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{I}] table [x=X, y=Y] {sk.txt};
% \addplot [thick, black, discard if not={P}{A}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{B}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{C}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{D}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{E}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{F}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{G}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{H}] table [x=X, y=Y] {native.txt};
% \addplot [thick, black, discard if not={P}{I}] table [x=X, y=Y] {native.txt};
% 	\end{axis}
% \end{tikzpicture}
