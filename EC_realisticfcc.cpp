...
VectorXcd greens(double k_x, double k_z, double a, dcomp omega, int N, dmat &u,
		...
		dmat &tu_1, dmat &tu_3, dmat &tu_4, dmat &tu_5,	dmat &tu_7,
	       	dmat &tu_9, dmat &tu_10, dmat &tu_12, dmat &tu_13,
		dmat &tu_14, dmat &tu_15, dmat &tu_16, dmat &tu_17, dmat &tu_18, dmat &u_d,
	       	dmat &td_1, dmat &td_3, dmat &td_4, dmat &td_5, dmat &td_7,
	       	dmat &td_9, dmat &td_10, dmat &td_12, dmat &td_13,
	...
	/* Tu << tu_15, zero, uu_12.adjoint(), tu_15; */
	...
	/* Td << td_15, zero, ud_12.adjoint(), td_15; */
...
//mobius transformation layer 2 from layer 1 to spacer thickness, N
	...
	for (int it=0; it < N; ++it){
		tmpu = (A1.array().pow((it+1)/10.).matrix()).asDiagonal()*fu*(A2.array().pow(-(it+1)/10.).matrix()).asDiagonal();
		tmpd = (A1.array().pow((it+1)/10.).matrix()).asDiagonal()*fd*(A2.array().pow(-(it+1)/10.).matrix()).asDiagonal();
...
int main(){
	...
	for (int j=0; j!=10; j++){
		...
		result_complex = result_complex + kspace(&greens, 2, 5e-2, 2*a, E, N,
				...
				u_u, tu_1, tu_3, tu_4, tu_5, tu_7, tu_9, tu_10, tu_12,
				tu_13, tu_14, tu_15, tu_16, tu_17, tu_18,
				u_d, td_1, td_3, td_4, td_5, td_7, td_9, td_10, td_12,
